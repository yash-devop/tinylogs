...
import { LoggerDemonstration } from "../components/code-demo/logger-demonstration";
        ...
        <div className="mt-14 md:mt-16 py-10 text-center flex flex-col items-center gap-y-4 relative w-full overflow-hidden">
          <div className="space-y-4">
            ...
            <p className="text-sm md:text-[16px] max-w-xl text-center text-neutral-600 tracking-tight text-balance">
              ...
              full request context, collapsing repetitive logs, and surfacing
          ...
          <div className="relative w-full h-full md:pb-[260px]">
            <LogsFlowWorkArea />
          </div>
          <div className="relative w-full h-full flex flex-col gap-y-10">
            <MainSection>
              <HeadingSection.Section className="pb-12">
                ...
                <HeadingSection.Description className="text-neutral-500">
                  Logs without context are just noise. Attach request IDs,
                  users, services, and custom metadata once, and TinyLogs
                  automatically propagates them across every event—making it
                  easy to understand what happened, where, and why.
                </HeadingSection.Description>
              </HeadingSection.Section>
              <LoggerDemonstration code={SNIPPETS.LOGGER_SET} />
            </MainSection>
            <FrameworkSection />
          </div>
        </div>
